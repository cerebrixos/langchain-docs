...
See [Sandbox lifecycle](/oss/python/deepagents/going-to-production#lifecycle) in
[Going to production](/oss/python/deepagents/going-to-production) for thread-scoped
...
<Note>
  Like [Going to production](/oss/python/deepagents/going-to-production#lifecycle), the
...
Backend and sandbox (see [Going to production](/oss/python/deepagents/going-to-production)):
