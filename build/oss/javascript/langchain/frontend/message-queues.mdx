...
Import your agent and pass `typeof myAgent` as a type parameter to [`useStream`](https://reference.langchain.com/javascript/langchain-react/index/useStream) for type-safe access to state values:
