...
See [Sandbox lifecycle](/oss/javascript/deepagents/going-to-production#lifecycle) in
[Going to production](/oss/javascript/deepagents/going-to-production) for thread-scoped
...
<Note>
  Like [Going to production](/oss/javascript/deepagents/going-to-production#lifecycle), the
...
Backend and sandbox (see [Going to production](/oss/javascript/deepagents/going-to-production)):
