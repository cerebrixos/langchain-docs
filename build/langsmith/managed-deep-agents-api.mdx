...
For an end-to-end CLI workflow and REST examples, see [Deploy Managed Deep Agents](/langsmith/deploy-managed-deep-agent).
...
For operational notes about supported models, thread retention, rate limits, agent limits, SDK availability, and support channels during preview, see [Limits and notes](/langsmith/deploy-managed-deep-agent#limits-and-notes) in the deploy guide.
